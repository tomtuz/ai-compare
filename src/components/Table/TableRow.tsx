...
export function TableRow({
  ...
  return (
    <tr className={`hover:bg-gray-50 ${isFavorite ? "bg-yellow-50" : ""}`}>
      ...
      <TableCell
        className="hidden whitespace-nowrap px-6 py-4 text-center text-sm text-gray-500 md:table-cell md:p-2 lg:text-lg"
      ...
      {columns.map((column) => (
        <TableCell
          ...
          className={`sm:p0 whitespace-nowrap text-center text-gray-900 sm:text-sm md:p-2 md:px-2 md:py-2 md:text-base xl:px-6 xl:text-base ${column.responsiveClasses}`}
          isEditing={
